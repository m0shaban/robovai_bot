...
async def execute_broadcast(
    ...
    for lead in target_leads:
        ...
        for integ in integrations:
            try:
                ...
                elif integ.channel_type == ChannelType.WHATSAPP and integ.access_token and integ.external_id:
                ...
                elif integ.channel_type in [ChannelType.MESSENGER, ChannelType.INSTAGRAM] and integ.access_token:
    ...
    broadcast.status = BroadcastStatus.COMPLETED if failed_count == 0 else BroadcastStatus.FAILED
    session.add(broadcast)
    await session.commit()
