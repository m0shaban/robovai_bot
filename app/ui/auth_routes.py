...
async def register_submit(
    ...
    try:
        ...
        return jinja_templates.TemplateResponse(
            "auth/register.html", {"request": request, "error": f"حدث خطأ: {str(e)}"}
        )
...
async def login_submit(
    ...
    if not user.is_verified:
        return jinja_templates.TemplateResponse(
            ...
            {
                "request": request,
                "error": "يرجى تفعيل حسابك أولاً. تحقق من بريدك الإلكتروني أو أعد إرسال رابط التفعيل.",
                "email": email,
...
async def forgot_password_page(request: Request):
    ...
    return jinja_templates.TemplateResponse(
        "auth/forgot_password.html", {"request": request}
    )
...
async def forgot_password_submit(
    ...
    return jinja_templates.TemplateResponse(
        "auth/forgot_password.html", {"request": request, "success": True}
    )
...
async def reset_password_page(
    ...
    if not user:
        return jinja_templates.TemplateResponse(
            "auth/reset_password.html", {"request": request, "token_invalid": True}
        )
...
async def verify_email_page(
    ...
    return jinja_templates.TemplateResponse(
        "auth/verify_email.html", {"request": request, "success": True}
    )
...
@auth_ui_router.post("/resend-verification")
